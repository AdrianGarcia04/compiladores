...
{cadena}     { ECHO; return crea_token_valor(STR, yytext); }
{num_ent}    { ECHO; return crea_token_valor_tipo(NUM, yytext, 0); }
{num_float}  { ECHO; return crea_token_valor_tipo(NUM, yytext, 1); }
{id}         { ECHO; return crea_token_valor(ID, yytext); }
{whitespace} ECHO;
